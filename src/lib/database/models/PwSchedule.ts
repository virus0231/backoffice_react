...
interface PwScheduleAttributes {
  id?: number;
  did: number;
  tid: number;
  td_id?: number;
...
interface PwScheduleCreationAttributes extends Optional<PwScheduleAttributes, 'id' | 'td_id' | 'plan_id' | 'sub_id' | 'cccharges' | 'event_id'> {}

class PwSchedule extends Model<PwScheduleAttributes, PwScheduleCreationAttributes> implements PwScheduleAttributes {
  public id!: number;
  public did!: number;
  public tid!: number;
  public td_id!: number;
...
PwSchedule.init(
  {
    ...
    cccharges: { type: DataTypes.TINYINT },
  ...
  },
  {
    ...
    tableName: 'pw_schedule',
    timestamps: true,
    underscored: false,
  }
);

export default PwSchedule;
export type { PwScheduleAttributes, PwScheduleCreationAttributes };
