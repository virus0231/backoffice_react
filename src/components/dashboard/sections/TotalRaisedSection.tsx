...
export default function TotalRaisedSection({ granularity }: Props) {
  const { data, loading, error } = useAnalytics(`/api/v1/analytics/total-raised?granularity=${granularity}`, 'totalRaised');
  ...
  return (
    <ChartWrapper chartId="totalRaised" title="Raised" enableComparison>
      {/* Metrics Row */}
