...
const CLIENTS = [
  {
    ...
    name: 'Mausa',
    icon: '🏢',
    apiUrl: process.env.NEXT_PUBLIC_API_URL_MAUSA || 'https://backend.mausa.org/insights/api'
  },
  {
    id: 'amoud',
    name: 'Amoud',
    icon: '🏛️',
    apiUrl: process.env.NEXT_PUBLIC_API_URL_AMOUD || 'https://backend.amoud.org/insights/api'
  },
];
...
export function useClientApiUrl(): string {
  ...
  return client?.apiUrl || process.env.NEXT_PUBLIC_PHP_API_BASE_URL || '/php-api';
}